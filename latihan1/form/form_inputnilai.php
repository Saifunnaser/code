...
<head>
    ...
    <title>Form Input Hasil Ujian</title>
...
<body>
    <div class="container">
        <form action="form_hasilujian.php" method="post">
        <div class="mb-3">
            <label for="formGroupExampleInput" class="form-label">Nilai UTS</label>
            <input type="number" name="nilaiUTS" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder">
        </div>
        <div class="mb-3">
